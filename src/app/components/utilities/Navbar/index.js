...
const Navbar = () => {
  return (
    <div className="fixed top-0 left-0 right-0 p-6 flex items-center justify-between bg-[#9A3B3B] shadow-md">
      ...
      <div className="flex items-center space-x-10">
        ...
        <Link href="/wayang" className="text-slate-100 text-lg hover:text-[#F2EEBF] hover:underline hover:font-bold transition-all duration-00">Wayang</Link>
      </div>
    </div>
  );
};
